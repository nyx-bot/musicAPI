...
module.exports = {
    ...
    func: async ({util, keys}, req, res) => {
        ...
        const noDownload = req.body ? req.body.noDownload : false, waitForDownload = req.body ? req.body.waitForDownload : false;

        console.log(`noDownload: ${noDownload} / waitForDownload: ${waitForDownload}`)

        require('../func/getInfo')(link, keys, noDownload, waitForDownload).then(json => {
            if(json) {
